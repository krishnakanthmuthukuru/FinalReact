    ...
    this.state.data.map(function(d){
      return (
        ...
        React.createElement("div", {className: "col-lg-12 well"}, 
           React.createElement("button", {className: "btn btn-link", type: "submit", "data-toggle": "modal", "data-target": "#myModal", value: d.name, onClick: a.viewmore}, d.name, ",", d.sys.country), 
       d.weather[0].description, 
       React.createElement("p", null, 
          React.createElement("span", {className: "badge"}, d.main.temp), "temperature from ", d.main.temp_min, " to ", d.main.temp_max, "°С, wind ", d.wind.speed, "m/s. clouds ", d.clouds.all, "%, ", d.main.sea_level, " hpa"
       ), 
       React.createElement("p", null, 
         ...
         React.createElement("div", {className: "col-lg-6"}, 
           React.createElement("button", {className: "btn btn-info", type: "submit", value: d, onClick: a.addToDB}, "Refresh")
           )
           )
      );
    }), 
...
this.state.data1.map(function(d){
 return(
   ...
   d
     ...
     React.createElement("div", {className: "col-lg-6"}, 
       React.createElement("button", {className: "btn btn-warning", type: "submit", value: d, onClick: a.addToDB}, "Refresh")
       )
       )
 );
})
...
React.render(React.createElement(WeatherForeCast, null),document.getElementById('app'));
},{"react":198,"react-router":34}]},{},[199]);
